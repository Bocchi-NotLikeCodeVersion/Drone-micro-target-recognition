...
class YOLO11:
    ...
    def main(self):
        ...
        # 获取输入图像的目录和文件名（不带扩展）
        img_dir, img_name = os.path.split(self.input_image)
        img_name_without_ext = os.path.splitext(img_name)[0]

        # 构造结果图像的路径
        output_img_path = os.path.join(img_dir, f"{img_name_without_ext}_result.jpg")
        ...
        print(f"图像已保存为 {output_img_path}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="./model/best.onnx", help="输入你的 ONNX 模型路径。")
    parser.add_argument("--img", type=str, default=r"..\media\0000001_03999_d_0000007.jpg", help="输入图像的路径。")
    ...
    # 打印结果图片的地址
    print(f"结果图片的地址: {result_image_path}")
